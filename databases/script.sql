...
--
-- Client: localhost
-- Généré le: Mar 13 Novembre 2012 à 20:46
...
--
-- Base de données: `aggregate_data`
--
CREATE DATABASE `aggregate_data` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `aggregate_data`;
...
--
-- Structure de la table `pages_keywords`
--
...
--
-- Contraintes pour la table `pages_keywords`
--
ALTER TABLE `pages_keywords`
  ADD CONSTRAINT `pages_keywords_ibfk_2` FOREIGN KEY (`keywordID`) REFERENCES `keywords` (`keywordID`) ON DELETE CASCADE,
  ADD CONSTRAINT `pages_keywords_ibfk_1` FOREIGN KEY (`pageID`) REFERENCES `pages` (`pageID`) ON DELETE CASCADE;
--
...
('def', 'aggregate_data', 'keywords', 'keywordID', 1, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(20)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'aggregate_data', 'keywords', 'label', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'aggregate_data', 'pages', 'pageID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'aggregate_data', 'pages', 'url', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'aggregate_data', 'pages', 'rank', 3, NULL, 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'aggregate_data', 'pages', 'backlinks', 4, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(20)', '', '', 'select,insert,update,references', ''),
('def', 'aggregate_data', 'pages_keywords', 'pageID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'aggregate_data', 'pages_keywords', 'keywordID', 2, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(20)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'aggregate_data', 'pages_keywords', 'rank', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
...
('def', 'raw_data', 'logs', 'log_id', 1, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(20)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'raw_data', 'logs', 'crawl_date', 2, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'raw_data', 'logs', 'url', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'raw_data', 'logs', 'html_tag', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'raw_data', 'logs', 'content', 5, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'references', 'social_modules', 'socialID', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'references', 'social_modules', 'type', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'references', 'social_modules', 'rank', 3, NULL, 'NO', 'decimal', NULL, NULL, 3, 2, NULL, NULL, 'decimal(3,2)', '', '', 'select,insert,update,references', ''),
('def', 'references', 'tags', 'tagID', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'references', 'tags', 'label', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'references', 'tags', 'rank', 3, NULL, 'NO', 'decimal', NULL, NULL, 3, 2, NULL, NULL, 'decimal(3,2)', '', '', 'select,insert,update,references', '');
...
('COM_SHOW_SLAVE_STATUS', '42'),
('COM_SHOW_STATUS', '0'),
('COM_SHOW_STORAGE_ENGINES', '10'),
('COM_SHOW_TABLE_STATUS', '453'),
('COM_SHOW_TABLES', '119'),
('COM_SHOW_TRIGGERS', '103'),
('COM_SHOW_VARIABLES', '83'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '382'),
('CREATED_TMP_DISK_TABLES', '815'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '3390'),
('DELAYED_ERRORS', '0'),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '32'),
('HANDLER_READ_FIRST', '208'),
('HANDLER_READ_KEY', '184'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '1257'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '31795'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
...
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '812'),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '7475'),
('INNODB_BUFFER_POOL_READS', '147'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1870'),
('INNODB_DATA_FSYNCS', '218'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '4591616'),
('INNODB_DATA_READS', '157'),
('INNODB_DATA_WRITES', '577'),
('INNODB_DATA_WRITTEN', '13489664'),
('INNODB_DBLWR_PAGES_WRITTEN', '406'),
('INNODB_DBLWR_WRITES', '40'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '273'),
('INNODB_LOG_WRITES', '96'),
('INNODB_OS_LOG_FSYNCS', '131'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '167936'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '82'),
('INNODB_PAGES_READ', '146'),
('INNODB_PAGES_WRITTEN', '406'),
...
('INNODB_ROWS_INSERTED', '18'),
('INNODB_ROWS_READ', '344'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '5172'),
('UPTIME_SINCE_FLUSH_STATUS', '5172');
...
('PID_FILE', 'D:\\Wamp\\bin\\mysql\\mysql5.5.24\\data\\Alexis-PC.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'D:\\Wamp\\bin\\mysql\\mysql5.5.24\\data\\Alexis-PC.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'D:\\Wamp\\bin\\mysql\\mysql5.5.24\\data\\Alexis-PC-slow.log'),
...
('def', 'aggregate_data', 'PRIMARY', 'def', 'aggregate_data', 'keywords', 'keywordID', 1, NULL, NULL, NULL, NULL),
('def', 'aggregate_data', 'PRIMARY', 'def', 'aggregate_data', 'pages', 'pageID', 1, NULL, NULL, NULL, NULL),
('def', 'aggregate_data', 'PRIMARY', 'def', 'aggregate_data', 'pages_keywords', 'pageID', 1, NULL, NULL, NULL, NULL),
('def', 'aggregate_data', 'PRIMARY', 'def', 'aggregate_data', 'pages_keywords', 'keywordID', 2, NULL, NULL, NULL, NULL),
('def', 'aggregate_data', 'pages_keywords_ibfk_2', 'def', 'aggregate_data', 'pages_keywords', 'keywordID', 1, 1, 'aggregate_data', 'keywords', 'keywordID'),
('def', 'aggregate_data', 'pages_keywords_ibfk_1', 'def', 'aggregate_data', 'pages_keywords', 'pageID', 1, 1, 'aggregate_data', 'pages', 'pageID'),
...
('def', 'raw_data', 'PRIMARY', 'def', 'raw_data', 'logs', 'log_id', 1, NULL, NULL, NULL, NULL),
('def', 'references', 'PRIMARY', 'def', 'references', 'social_modules', 'socialID', 1, NULL, NULL, NULL, NULL),
('def', 'references', 'PRIMARY', 'def', 'references', 'tags', 'tagID', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-13 20:46:14', '2012-11-13 20:46:14', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-13 20:46:14', '2012-11-13 20:46:14', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-13 20:46:14', '2012-11-13 20:46:14', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-13 20:46:14', '2012-11-13 20:46:14', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-13 20:46:14', '2012-11-13 20:46:14', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-13 20:46:14', '2012-11-13 20:46:14', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-13 20:46:14', '2012-11-13 20:46:14', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-13 20:46:14', '2012-11-13 20:46:14', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-13 20:46:14', '2012-11-13 20:46:14', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2012-11-13 20:46:14', NULL, NULL, NULL, '', '', NULL),
('def', 'aggregate_data', 'keywords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 8388608, '2012-11-13 19:39:07', NULL, NULL, NULL, '', '', NULL),
('def', 'aggregate_data', 'pages', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 8388608, '2012-11-13 19:35:14', NULL, NULL, NULL, '', '', NULL),
('def', 'aggregate_data', 'pages_keywords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 8388608, '2012-11-13 19:43:40', NULL, NULL, NULL, '', '', NULL),
...
('def', 'raw_data', 'logs', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 8388608, '2012-11-13 20:07:12', NULL, NULL, NULL, '', '', NULL),
('def', 'references', 'social_modules', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 8388608, '2012-11-13 20:19:54', NULL, NULL, NULL, '', '', NULL),
('def', 'references', 'tags', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 0, 8388608, '2012-11-13 20:16:07', NULL, NULL, NULL, '', '', NULL);
...
(381, 'root', 'localhost:50716', 'aggregate_data', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'aggregate_data', 'pages_keywords_ibfk_2', 'def', 'aggregate_data', 'PRIMARY', 'NONE', 'RESTRICT', 'CASCADE', 'pages_keywords', 'keywords'),
('def', 'aggregate_data', 'pages_keywords_ibfk_1', 'def', 'aggregate_data', 'PRIMARY', 'NONE', 'RESTRICT', 'CASCADE', 'pages_keywords', 'pages');
...
('def', 'aggregate_data', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'raw_data', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'references', 'latin1', 'latin1_swedish_ci', NULL);
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '7622'),
('INNODB_BUFFER_POOL_READS', '147'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1870'),
('INNODB_DATA_FSYNCS', '218'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '5173'),
('UPTIME_SINCE_FLUSH_STATUS', '5173');
...
('def', 'aggregate_data', 'keywords', 0, 'aggregate_data', 'PRIMARY', 1, 'keywordID', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'aggregate_data', 'pages', 0, 'aggregate_data', 'PRIMARY', 1, 'pageID', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'aggregate_data', 'pages_keywords', 0, 'aggregate_data', 'PRIMARY', 1, 'pageID', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'aggregate_data', 'pages_keywords', 0, 'aggregate_data', 'PRIMARY', 2, 'keywordID', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'aggregate_data', 'pages_keywords', 1, 'aggregate_data', 'keywordID', 1, 'keywordID', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'raw_data', 'logs', 0, 'raw_data', 'PRIMARY', 1, 'log_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'references', 'social_modules', 0, 'references', 'PRIMARY', 1, 'socialID', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'references', 'tags', 0, 'references', 'PRIMARY', 1, 'tagID', 'A', 7, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-13 20:46:15', '2012-11-13 20:46:15', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-13 20:46:15', '2012-11-13 20:46:15', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-13 20:46:15', '2012-11-13 20:46:15', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-13 20:46:15', '2012-11-13 20:46:15', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-13 20:46:15', '2012-11-13 20:46:15', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-13 20:46:15', '2012-11-13 20:46:15', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-13 20:46:15', '2012-11-13 20:46:15', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-13 20:46:15', '2012-11-13 20:46:15', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-13 20:46:15', '2012-11-13 20:46:15', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2012-11-13 20:46:15', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'aggregate_data', 'keywords', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 8388608, 1, '2012-11-13 19:39:07', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'aggregate_data', 'pages', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 8388608, 1, '2012-11-13 19:35:14', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'aggregate_data', 'pages_keywords', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 8388608, NULL, '2012-11-13 19:43:40', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
...
('def', 'raw_data', 'logs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 8388608, 1, '2012-11-13 20:07:12', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'references', 'social_modules', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 8388608, NULL, '2012-11-13 20:19:54', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'references', 'tags', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 0, 8388608, NULL, '2012-11-13 20:16:07', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');
...
('def', 'aggregate_data', 'PRIMARY', 'aggregate_data', 'keywords', 'PRIMARY KEY'),
('def', 'aggregate_data', 'PRIMARY', 'aggregate_data', 'pages', 'PRIMARY KEY'),
('def', 'aggregate_data', 'PRIMARY', 'aggregate_data', 'pages_keywords', 'PRIMARY KEY'),
('def', 'aggregate_data', 'pages_keywords_ibfk_2', 'aggregate_data', 'pages_keywords', 'FOREIGN KEY'),
('def', 'aggregate_data', 'pages_keywords_ibfk_1', 'aggregate_data', 'pages_keywords', 'FOREIGN KEY'),
...
('def', 'raw_data', 'PRIMARY', 'raw_data', 'logs', 'PRIMARY KEY'),
('def', 'references', 'PRIMARY', 'references', 'social_modules', 'PRIMARY KEY'),
('def', 'references', 'PRIMARY', 'references', 'tags', 'PRIMARY KEY');
...
--
-- Base de données: `raw_data`
--
CREATE DATABASE `raw_data` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `raw_data`;
...
--
-- Base de données: `references`
--
CREATE DATABASE `references` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `references`;

-- --------------------------------------------------------

--
-- Structure de la table `social_modules`
--

CREATE TABLE IF NOT EXISTS `social_modules` (
  `socialID` tinyint(4) NOT NULL,
...
--
-- Contenu de la table `social_modules`
--

INSERT INTO `social_modules` (`socialID`, `type`, `rank`) VALUES
(1, 'Google+', '3.00'),
(2, 'Facebook', '2.50'),
(3, 'Twitter', '2.00'),
(4, 'Comments', '1.50');
...
INSERT INTO `tags` (`tagID`, `label`, `rank`) VALUES
(1, 'title', '5.00'),
(2, 'h1', '3.50'),
(3, 'h2', '2.50'),
(4, 'h3', '2.00'),
